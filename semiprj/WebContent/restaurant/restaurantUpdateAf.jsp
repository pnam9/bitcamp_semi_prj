...
// DB에 Data저장
    ...
    boolean result = dao.updateRestaurant(new RestaurantDto(seq1 ,id, name, tel, location, operatingTime, kinds, score1, title, review, filename, newfilename ));
    if(result){
%>
...
<script type="text/javascript">
    alert('게시글 수정 실패');
    location.href = "main.jsp?content=/restaurant/restaurantUpdate&seq=<%=seq1%>";
</script>
<%
    }
%>
