...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
 <%
    ...
    List<RestaurantDto> list = dao.getRestaurantPagingList(mem.getId(), location, choice, search, pageNumber);

    int len = dao.getAllRestaurant(location, choice, search);
    System.out.println("총 글의 수:" + len);

    LikedDao likeDao = LikedDao.getInstance();
...
<div class="container" style="margin-top: 50px;">
    <h2><span style="font-family: 'ONE-Mobile-POP'; font-size: 35pt; color: #333333; text-shadow: 2px 2px 0px #FFFFFF, 5px 4px 0px rgba(0,0,0,0.15); "> "<%=location%>" 지역 맛집 </span></h2><br><br>
    <!-- 검색창, 검색버튼 -->
      ...
      <!-- 검색창, 검색버튼 끝 -->
        ...
        <div class="col-md-4" style="float: left; margin-bottom: 40px;">
            <div class="card shadow" style="width: 20rem;">
                <a href = main.jsp?content=/restaurant/restaurantDetail&seq=<%=dto.getSeq()%>&location=<%=location%> style="margin-top: auto">
                <div class="inner">
...
<% } %>
<div class="container" style="margin : auto; padding: 5px ">
    <div class="row">
...
<script type="text/javascript">
    ...
    function searchBtn() {
        ...
        location.href = "main.jsp?content=/restaurant/restaurantList&location=" + '<%=location%>' + "&choice=" + choice + "&search=" + search;
    }
    ...
    function goPage( pageNum ) {
        ...
        console.log("gopage choice = " +choice );

        let search = document.getElementById("search").value;
        console.log("gopage search = " +search );
        ...
        location.href = "main.jsp?content=/restaurant/restaurantList&location=" + '<%=location%>' + "&choice=" + choice + "&search=" + search + "&pageNumber=" + pageNum;
    }
